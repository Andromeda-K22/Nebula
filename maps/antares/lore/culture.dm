/decl/cultural_info/culture/sol
	name = "Vulcanoid"
	description = "People from the innermost area of Sol are usually career officers in the Dominion navy, as there is \
...
/decl/cultural_info/culture/oort
	...
	description = "There are only three kinds of people who live in the depths of the mind-rendingly distant Oort cloud: criminals, \
		Dominion agents chasing criminals, and folk who are very, very lost."